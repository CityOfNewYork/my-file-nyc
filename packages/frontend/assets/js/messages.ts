...
export default merge(
  {
    ...
    urd: {
      ...
      navigation: {
        ...
        settingsFirstRun: 'Welcome to #My File NYC&! Please answer a few questions about yourself to get started.',
        welcomeFirstRun: 'میری فائل NYC میں خوش آمدید!',
        activity: 'سرگرمی لاگ',
        back: 'Back',
        clients: 'Clients', // navigate back to agent view desktop
        close: 'Close',
      ...
      controls: {
        ...
        allFiles: 'آپ کے دستاویزات', // shown as tab label on the dashboard
        cancel: 'Cancel', // cancel button
        confirm: 'Confirm',
        confirmDelete: 'Yes, Delete',
        declineAndLogOut: 'Decline & Log Out', // decline TOS button
        ...
        continue: 'Continue',
        share: 'Share with DHS', // share button
        shared: 'مشترکہ دستاویزات', // label of shared tab on dashboard
        upload: 'Upload a Document',
        uploadDocument: 'Upload Document',
        view: 'View',
        save: 'Save',
