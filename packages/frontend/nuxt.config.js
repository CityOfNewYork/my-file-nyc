      ...
      new CspHtmlWebpackPlugin(
        {
          ...
          'worker-src': ["'self'"],
          'style-src': [...getSrc(CspEnum.SCRIPT, process.env.CSP_STYLE_SRC_ELEM), "'self'", "'unsafe-inline'", "'unsafe-eval'"],
          'style-src-elem': [...getSrc(CspEnum.SCRIPT, process.env.CSP_STYLE_SRC_ELEM),
          ...
          'font-src': getSrc(CspEnum.SCRIPT, process.env.CSP_FONT_SCR),
          'form-action': ["'self'"],
